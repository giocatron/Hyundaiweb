<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/suv/new_tucson/cover.jpeg`" alt="Portada Hyundai Tucson" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/suv/new_tucson/components/Feature.vue'
import Motorization from '@/views/sections/suv/new_tucson/components/Motorization.vue'
import Price from '@/views/sections/suv/new_tucson/components/Price.vue'
export default {
    data() {
        return {
            features: true,
