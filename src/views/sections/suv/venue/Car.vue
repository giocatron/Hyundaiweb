<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/suv/venue/cover.jpg`" alt="Portada Venue" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/suv/venue/components/Feature.vue'
import Motorization from '@/views/sections/suv/venue/components/Motorization.vue'
import Price from '@/views/sections/suv/venue/components/Price.vue'
export default {
    data() {
        return {
            features: true,
