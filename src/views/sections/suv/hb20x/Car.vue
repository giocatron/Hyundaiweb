<template>
    <div class="car">
        <div class="bg-white pb-5">
            <div class="cover">
                <img :src="`../static/img/section_transport/suv/hb20x/hyundai-hb20x-new.jpg`" alt="Portada Hyundai hb20x" class="img-fluid w-100">
            </div>
...
import Feature from '@/views/sections/suv/hb20x/components/Feature.vue'
import Motorization from '@/views/sections/suv/hb20x/components/Motorization.vue'
import Price from '@/views/sections/suv/hb20x/components/Price.vue'
export default {
    data() {
        return {
            features: true,
