<template>
    <div class="car">
        <div class="cover">
            <img :src="`static/img/section_transport/suv/i20_active/cover.jpg`" alt="Portada Hyundai All New Santa Fe" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/suv/i20_active/components/Feature.vue'
import Motorization from '@/views/sections/suv/i20_active/components/Motorization.vue'
import Price from '@/views/sections/suv/i20_active/components/Price.vue'
export default {
    data() {
        return {
            features: true,
