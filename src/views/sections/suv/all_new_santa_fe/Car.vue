<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/suv/all_new_santa_fe/cover.jpg`" alt="Portada Hyundai All New Santa Fe" class="img-fluid">
        </div>
        <div class="nav-car d-flex">
            <ul class="navbar-nav d-flex flex-row mx-auto ">
                ...
                <!-- <li class="nav-item active">
                    <div v-on:click="activeComponenent('motor')" class="nav-link pointer">Motorización</div>
                </li> -->
                <li class="divider-vertical"></li>
                <li class="nav-item active">
...
import Feature from '@/views/sections/suv/all_new_santa_fe/components/Feature.vue'
import Motorization from '@/views/sections/suv/all_new_santa_fe/components/Motorization.vue'
import Price from '@/views/sections/suv/all_new_santa_fe/components/Price.vue'
export default {
    data() {
        return {
            features: true,
            ...
            switch (value) {
                ...
                case "motor":
                 ...
                 case "price":
                    ...
                    // this.price = true;
                    // this.features = this.motor = false;
                    break;
