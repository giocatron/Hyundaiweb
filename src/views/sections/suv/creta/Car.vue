<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/suv/creta/cover-layer7.png`" alt="Portada Hyundai All New Santa Fe" class="img-fluid w-100">
        </div>
...
import Feature from '@/views/sections/suv/creta/components/Feature.vue'
import Motorization from '@/views/sections/suv/creta/components/Motorization.vue'
import Price from '@/views/sections/suv/creta/components/Price.vue'
export default {
    data() {
        return {
            features: true,
