<template>
    <div class="car">
        <div class="cover">
            <img :src="`static/img/section_transport/suv/grand_santa_fe/cover.jpeg`" alt="Portada Hyundai All New Santa Fe" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/suv/grand_santa_fe/components/Feature.vue'
import Motorization from '@/views/sections/suv/grand_santa_fe/components/Motorization.vue'
import Price from '@/views/sections/suv/grand_santa_fe/components/Price.vue'
export default {
    data() {
        return {
            features: true,
