<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/suv/palisade/cover.jpg`" alt="Portada Palisade" class="img-fluid">
        </div>
        <div class="nav-car d-flex pb-4">
...
import Feature from '@/views/sections/suv/palisade/components/Feature.vue'
import Motorization from '@/views/sections/suv/palisade/components/Motorization.vue'
import Price from '@/views/sections/suv/palisade/components/Price.vue'
export default {
    data() {
        return {
            features: true,
