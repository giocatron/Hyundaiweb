<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/buses/county/cover.jpeg`" alt="Portada Hyundai H-100" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/buses/county/components/Feature.vue'
import Motorization from '@/views/sections/buses/county/components/Motorization.vue'
import Price from '@/views/sections/buses/county/components/Price.vue'
export default {
    data() {
        return {
            features: true,
