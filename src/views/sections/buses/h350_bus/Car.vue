<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/buses/h350_bus/cover2.jpeg`" alt="H350 camion" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/buses/h350_bus/components/Feature.vue'
import Motorization from '@/views/sections/buses/h350_bus/components/Motorization.vue'
