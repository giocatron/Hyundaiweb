<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/comercial/h_100/cover.jpeg`" alt="Portada Hyundai H-100" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/comercial/h_100/components/Feature.vue'
import Motorization from '@/views/sections/comercial/h_100/components/Motorization.vue'
import Price from '@/views/sections/comercial/h_100/components/Price.vue'
export default {
    data() {
        return {
            features: true,
