<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/cars/ioniq/cover.jpg`" alt="Portada Hyundai ioniq" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/cars/ioniq/components/Feature.vue'
import Motorization from '@/views/sections/cars/ioniq/components/Motorization.vue'
