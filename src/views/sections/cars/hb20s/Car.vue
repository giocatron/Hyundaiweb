<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/cars/hb20s/cover.jpg`" alt="Portada Hyundai HB20s" class="img-fluid w-100">
        </div>
...
import Feature from '@/views/sections/cars/hb20s/components/Feature.vue'
import Motorization from '@/views/sections/cars/hb20s/components/Motorization.vue'
import Price from '@/views/sections/cars/hb20s/components/Price.vue'
export default {
    data() {
        return {
            features: true,
