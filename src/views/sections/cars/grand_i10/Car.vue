<template>
    <div class="car">
        <div class="cover">
            <img :src="`static/img/section_transport/cars/grand_i10/cover.jpeg`" alt="Grand i10" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/cars/grand_i10/components/Feature.vue'
import Motorization from '@/views/sections/cars/grand_i10/components/Motorization.vue'
import Price from '@/views/sections/cars/grand_i10/components/Price.vue'
export default {
    data() {
        return {
            features: true,
