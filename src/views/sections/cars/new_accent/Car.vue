<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/cars/new_accent/cover.jpg`" alt="Portada Hyundai Accent" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/cars/new_accent/components/Feature.vue'
import Motorization from '@/views/sections/cars/new_accent/components/Motorization.vue'
import Price from '@/views/sections/cars/new_accent/components/Price.vue'
export default {
    data() {
        return {
            features: true,
