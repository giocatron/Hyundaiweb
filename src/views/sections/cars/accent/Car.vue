<template>
    <div class="car">
        <div class="cover">
            <img :src="`static/img/section_transport/cars/accent/cover.jpg`" alt="Portada Hyundai Accent" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/cars/accent/components/Feature.vue'
import Price from '@/views/sections/cars/accent/components/Price.vue'
export default {
    data() {
        return {
            features: true,
