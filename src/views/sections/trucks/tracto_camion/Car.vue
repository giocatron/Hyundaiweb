<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/trucks/tracto_camion/cover.jpeg`" alt="tracto_camion camion" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/trucks/tracto_camion/components/Feature.vue'
import Motorization from '@/views/sections/trucks/tracto_camion/components/Motorization.vue'
import Price from '@/views/sections/trucks/tracto_camion/components/Price.vue'
export default {
    data() {
        return {
            features: true,
