<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/trucks/volquete/cover.jpeg`" alt="volquete camion" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/trucks/volquete/components/Feature.vue'
import Motorization from '@/views/sections/trucks/volquete/components/Motorization.vue'
import Price from '@/views/sections/trucks/volquete/components/Price.vue'
export default {
    data() {
        return {
            features: true,
