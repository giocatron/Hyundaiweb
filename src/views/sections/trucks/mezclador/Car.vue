<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/trucks/mezclador/cover.jpg`" alt="mezclador camion" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/trucks/mezclador/components/Feature.vue'
import Motorization from '@/views/sections/trucks/mezclador/components/Motorization.vue'
import Price from '@/views/sections/trucks/mezclador/components/Price.vue'
export default {
    data() {
        return {
            features: true,
