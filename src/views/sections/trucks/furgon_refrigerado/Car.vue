<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/trucks/furgon_refrigerado/cover.jpeg`" alt="Portada Hyundai H-100" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/trucks/furgon_refrigerado/components/Feature.vue'
import Motorization from '@/views/sections/trucks/furgon_refrigerado/components/Motorization.vue'
import Price from '@/views/sections/trucks/furgon_refrigerado/components/Price.vue'
export default {
    data() {
        return {
            features: true,
