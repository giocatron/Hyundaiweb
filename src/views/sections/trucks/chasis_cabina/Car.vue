<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/trucks/chasis_cabina/cover.jpg`" alt="Portada Hyundai H-100" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/trucks/chasis_cabina/components/Feature.vue'
import Motorization from '@/views/sections/trucks/chasis_cabina/components/Motorization.vue'
import Price from '@/views/sections/trucks/chasis_cabina/components/Price.vue'
export default {
    data() {
        return {
            features: true,
