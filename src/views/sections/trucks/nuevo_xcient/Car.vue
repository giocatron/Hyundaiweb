<template>
    <div class="car">
        <div class="cover">
            <img :src="`../static/img/section_transport/trucks/nuevo_xcient/cover.jpeg`" alt="nuevo_xcient camion" class="img-fluid">
        </div>
...
import Feature from '@/views/sections/trucks/nuevo_xcient/components/Feature.vue'
import Motorization from '@/views/sections/trucks/nuevo_xcient/components/Motorization.vue'
import Price from '@/views/sections/trucks/nuevo_xcient/components/Price.vue'
export default {
    data() {
        return {
            features: true,
